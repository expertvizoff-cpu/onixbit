...
const fallbackVisual: ArticleVisual = {
  ...
  alt: "Обезличенная схема проверки внедрения Битрикс24: заявка, сделка, задача и отчет",
  caption: "Рабочая схема для статьи. Позже ее можно заменить реальным скриншотом из демо-портала или коробочного Битрикс24.",
};

export const articleVisuals: Record<string, ArticleVisual> = {
  "poverhnostnoe-vnedrenie-bitrix24": {
    src: "/media/articles/bitrix24-surface-audit.svg",
    alt: "Обезличенная схема аудита внедрения Битрикс24 с проверками заявок, сделок, задач и отчетов",
