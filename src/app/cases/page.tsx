...
export const metadata: Metadata = {
  title: "Кейсы Ониксбит: Битрикс24, 1С-Битрикс, 1С и интеграции",
  description:
    "Формат кейсов Ониксбит по CRM, сайтам на 1С-Битрикс, 1С и интеграциям: задача, ограничения, архитектура решения и результат для B2B-команды.",
  alternates: {
    canonical: "/cases",
  },
  openGraph: {
    title: "Кейсы Ониксбит",
    description:
      "Разборы проектов, где Битрикс24, сайт, 1С и коммуникации работают как одна система.",
    url: "/cases",
    type: "website",
  },
};
      ...
      <section className="ob-page-hero ob-section ob-page-hero--cases">
        <div className="ob-container ob-rich-hero">
          <div>
            ...
            <p>
              Сейчас здесь показан формат будущих публичных разборов: без выдуманных клиентов и логотипов, но с понятной структурой,
              по которой можно оценить подход Ониксбит к CRM, сайтам, 1С и интеграциям.
            </p>
          </div>
          <div className="ob-page-status-card">
            <strong>Формат уже готов</strong>
            <span>Публикуем только согласованные материалы. До этого показываем направления, критерии и структуру будущих разборов.</span>
          </div>
        </div>
      </section>
