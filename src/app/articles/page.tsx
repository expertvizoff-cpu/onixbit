    ...
    <>
      ...
      <section className="ob-section ob-section--tight">
        <div className="ob-container ob-page-notice ob-article-hub-notice">
          ...
          <div>
            <p>
              Картинки в статьях сделаны как собственные обезличенные рабочие схемы. Позже эти места можно заменить
              реальными скриншотами или GIF из демо-портала, коробочного Битрикс24 или клиентского проекта после обезличивания.
            </p>
            <ul>
