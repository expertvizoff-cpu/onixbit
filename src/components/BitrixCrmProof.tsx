          ...
          >
            ...
            <div className="ob-crm-modal__grid">
              <article>
                ...
                <span>
                  Платформа объединяет CRM, задачи, чаты, автоматизацию, BI и приложения в одном рабочем контуре.
                </span>
              </article>
              <article>
                <BarChart3 size={22} aria-hidden="true" />
                <strong>Где теряются деньги</strong>
                <span>
                  Переплата появляется из-за лишних пользователей, слабых прав, ручных обменов и хаотичных воронок.
                </span>
              </article>
              <article>
                <CheckCircle2 size={22} aria-hidden="true" />
                <strong>Что делает Ониксбит</strong>
                <span>
                  Подбираем тариф под отделы, роли, диски, интеграции с 1С, сайтом, телефонией и отчётностью.
                </span>
              </article>
            </div>
