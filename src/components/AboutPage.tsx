...
const publicFormats = [
  {
    ...
    text: "Разбираем CRM, сайты и интеграции языком руководителя и команды проекта.",
  },
  {
    icon: FileText,
    title: "Проектные разборы",
    text: "Показываем ход решения: ограничения, архитектуру, результат и зоны ответственности.",
  },
  {
    icon: Handshake,
    title: "Открытая позиция",
    text: "Публикуем только то, что можно подтвердить опытом, статусами и согласованными материалами.",
  },
];
    ...
    <>
      ...
      <section className="ob-section ob-section--tight">
        <div className="ob-container">
          <SectionIntro
            ...
            text="Сначала фиксируем границы задачи, затем проектируем архитектуру, внедряем по этапам и заранее договариваемся, кто отвечает за результат."
          />
      ...
      <section className="ob-section ob-section--tight">
        <div className="ob-container ob-about-public">
          <div>
            ...
            <h2>Как мы показываем опыт и подход</h2>
            <p>
              Клиент заранее видит, как мы думаем: какие вопросы задаём на старте,
              где фиксируем границы проекта и по каким признакам принимаем результат.
            </p>
          </div>
      ...
      <section className="ob-section ob-section--tight">
        <div className="ob-container ob-about-materials">
          <SectionIntro
            kicker="Материалы"
            title="Материалы для принятия решений"
            text="Материалы помогают подготовиться к проекту: понять риски внедрения CRM, обменов с 1С, сайта как части продаж и контроля результата после запуска."
          />
