...
[[ "$BASE_RELEASE_ID" = 20260923-company-nav-661a811bc7 && "$BASE_BUILD_ID" = QiD9mAQb8LXWEHjFzvqZb ]]
...
echo 'Reviewed /design cases preview published. Production root HTML, application, current link and proxy start time preserved.'
