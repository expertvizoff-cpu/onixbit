...
[[ "$BASE_RELEASE_ID" = 20260923-company-1700-buttons-0243b12c28 && "$BASE_BUILD_ID" = 0_GMqYVKbqzVpIFcIwSuO ]]
...
echo 'Reviewed /design Bitrix24 service preview published. Production root HTML, application, current link and proxy start time preserved.'
